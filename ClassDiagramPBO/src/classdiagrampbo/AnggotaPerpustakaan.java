...
public class AnggotaPerpustakaan {
    ...
    public void pinjamBuku(Buku buku, TransaksiPeminjaman transaksi){
        if(buku.isIsAvailable()){
            ...
            System.out.println("Peminjaman Buku Dengan Judul " + buku.getJudul() + " Berhasil");
            System.out.println("Tanggal Awal: " + transaksi.getTanggal_awal());
            System.out.println("Tanggal Akhir: " + transaksi.getTanggal_akhir());
            return;
        }
